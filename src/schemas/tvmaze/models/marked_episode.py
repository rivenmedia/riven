...
from schemas.tvmaze.models.marked_episode_embedded import MarkedEpisodeEmbedded
...
class MarkedEpisode(BaseModel):
    ...
    marked_at: Optional[StrictInt] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["episode_id", "marked_at", "type", "_embedded"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "_embedded": (
                    MarkedEpisodeEmbedded.from_dict(obj["_embedded"])
