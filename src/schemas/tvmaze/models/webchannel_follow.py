...
class WebchannelFollow(BaseModel):
    ...
    embedded: Optional[WebchannelFollowEmbedded] = Field(
        default=None, alias="_embedded"
    )
    __properties: ClassVar[List[str]] = ["webchannel_id", "_embedded"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "_embedded": (
                    WebchannelFollowEmbedded.from_dict(obj["_embedded"])
