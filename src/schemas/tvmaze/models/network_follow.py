...
from schemas.tvmaze.models.network_follow_embedded import NetworkFollowEmbedded
...
class NetworkFollow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["network_id", "_embedded"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "_embedded": (
                    NetworkFollowEmbedded.from_dict(obj["_embedded"])
