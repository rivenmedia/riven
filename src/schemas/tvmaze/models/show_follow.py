...
from schemas.tvmaze.models.show_follow_embedded import ShowFollowEmbedded
...
class ShowFollow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["show_id", "_embedded"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShowFollow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShowFollow from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "_embedded": (
                    ShowFollowEmbedded.from_dict(obj["_embedded"])
