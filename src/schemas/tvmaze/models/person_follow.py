...
from schemas.tvmaze.models.person_follow_embedded import PersonFollowEmbedded
...
class PersonFollow(BaseModel):
    ...
    person_id: Optional[StrictInt] = None
    embedded: Optional[PersonFollowEmbedded] = Field(default=None, alias="_embedded")
    __properties: ClassVar[List[str]] = ["person_id", "_embedded"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "_embedded": (
                    PersonFollowEmbedded.from_dict(obj["_embedded"])
