...
class BulkResponseInner(BaseModel):
    ...
    code: Optional[StrictInt] = Field(
        default=None, description="The HTTP code that corresponds to this item"
    )
    message: Optional[StrictStr] = Field(
        default=None, description="A human-readable error message (in case of error)"
    )
    ...
    __properties: ClassVar[List[str]] = ["code", "message", "errors", "input", "result"]
