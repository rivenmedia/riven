...
class WebchannelFollowEmbedded(BaseModel):
    """
    WebchannelFollowEmbedded
    """  # noqa: E501

    webchannel: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["webchannel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebchannelFollowEmbedded from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebchannelFollowEmbedded from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"webchannel": obj.get("webchannel")})
        return _obj
