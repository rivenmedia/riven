...
class EpisodeVote(BaseModel):
    ...
    voted_at: Optional[StrictInt] = Field(
        default=None,
        description="Epoch timestamp for when the user voted for the episode",
    )
    vote: Optional[Annotated[int, Field(le=10, strict=True, ge=1)]] = Field(
        default=None, description="The vote number"
    )
    __properties: ClassVar[List[str]] = ["episode_id", "voted_at", "vote"]
