...
from schemas.tvmaze.models.auth_poll_post200_response import AuthPollPost200Response
from schemas.tvmaze.models.auth_poll_post_request import AuthPollPostRequest
from schemas.tvmaze.models.auth_start_post200_response import AuthStartPost200Response
from schemas.tvmaze.models.auth_start_post_request import AuthStartPostRequest
from schemas.tvmaze.models.auth_validate_get200_response import (
    AuthValidateGet200Response,
)

from schemas.tvmaze.api_client import ApiClient, RequestSerialized
from schemas.tvmaze.api_response import ApiResponse
from schemas.tvmaze.rest import RESTResponseType
...
class AuthApi:
    ...
    def _auth_poll_post_serialize(
        ...
        _auth_settings: List[str] = ["usertoken"]
    ...
    def auth_start_post(
        ...
        :param body: (required)
        :type body: AuthStartPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
