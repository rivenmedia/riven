...
from schemas.tvmaze.models.show_vote import ShowVote


class TestShowVote(unittest.TestCase):
    """ShowVote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowVote:
        """Test ShowVote
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ShowVote`
        """
        model = ShowVote()
        if include_optional:
            return ShowVote(
