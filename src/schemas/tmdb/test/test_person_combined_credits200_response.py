    ...
    def make_instance(self, include_optional) -> PersonCombinedCredits200Response:
        ...
        if include_optional:
            return PersonCombinedCredits200Response(
                cast = [
                    schemas.tmdb.models.person_combined_credits_200_response_cast_inner.person_combined_credits_200_response_cast_inner(
                        adult = False,
                ...
                crew = [
                    schemas.tmdb.models.person_combined_credits_200_response_crew_inner.person_combined_credits_200_response_crew_inner(
                        adult = False,
