...
class TestSyncApi(unittest.TestCase):
    ...
    def test_add_items_to_favorites(self) -> None:
        """Test case for add_items_to_favorites
    ...
    def test_remove_items_from_favorites(self) -> None:
        """Test case for remove_items_from_favorites
    ...
    def test_reorder_favorited_items(self) -> None:
        """Test case for reorder_favorited_items
    ...
    def test_update_a_favorite_item(self) -> None:
        """Test case for update_a_favorite_item

        Update a favorite item
        """
        pass

    def test_update_a_watchlist_item(self) -> None:
        """Test case for update_a_watchlist_item
