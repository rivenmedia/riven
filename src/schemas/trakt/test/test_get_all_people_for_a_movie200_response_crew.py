...
class TestGetAllPeopleForAMovie200ResponseCrew(unittest.TestCase):
    """GetAllPeopleForAMovie200ResponseCrew unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllPeopleForAMovie200ResponseCrew:
        """Test GetAllPeopleForAMovie200ResponseCrew
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetAllPeopleForAMovie200ResponseCrew`
        """
        model = GetAllPeopleForAMovie200ResponseCrew()
        if include_optional:
            return GetAllPeopleForAMovie200ResponseCrew(
                production = [
                    schemas.trakt.models.get_all_people_for_a_movie_200_response_crew_production_inner.Get_all_people_for_a_movie_200_response_crew_production_inner(
                        jobs = [
                            ''
                            ],
                        person = schemas.trakt.models.get_items_on_a_list_200_response_inner_person.Get_items_on_a_list_200_response_inner_person(
                            name = '',
                ...
                art = [
                    schemas.trakt.models.get_all_people_for_a_movie_200_response_crew_art_inner.Get_all_people_for_a_movie_200_response_crew_art_inner(
                        jobs = [
                            ''
                            ],
                        person = schemas.trakt.models.get_items_on_a_list_200_response_inner_person.Get_items_on_a_list_200_response_inner_person(
                ...
                directing = [
                    schemas.trakt.models.get_all_people_for_a_movie_200_response_crew_directing_inner.Get_all_people_for_a_movie_200_response_crew_directing_inner(
                        jobs = [
                            ''
                            ],
                        person = schemas.trakt.models.get_items_on_a_list_200_response_inner_person.Get_items_on_a_list_200_response_inner_person(
    ...
    def testGetAllPeopleForAMovie200ResponseCrew(self):
        """Test GetAllPeopleForAMovie200ResponseCrew"""
