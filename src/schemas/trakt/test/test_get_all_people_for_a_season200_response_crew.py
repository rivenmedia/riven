...
class TestGetAllPeopleForASeason200ResponseCrew(unittest.TestCase):
    """GetAllPeopleForASeason200ResponseCrew unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllPeopleForASeason200ResponseCrew:
        """Test GetAllPeopleForASeason200ResponseCrew
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetAllPeopleForASeason200ResponseCrew`
        """
        model = GetAllPeopleForASeason200ResponseCrew()
        if include_optional:
            return GetAllPeopleForASeason200ResponseCrew(
                production = [
                    schemas.trakt.models.get_all_people_for_a_show_200_response_crew_art_inner.Get_all_people_for_a_show_200_response_crew_art_inner(
                        jobs = [
                            ''
                            ],
                        episode_count = 1.337,
                ...
                sound = [
                    schemas.trakt.models.get_all_people_for_a_show_200_response_crew_visual_effects_inner.Get_all_people_for_a_show_200_response_crew_visual_effects_inner(
                        jobs = [
                            ''
                            ],
                        episode_count = 1.337,
    ...
    def testGetAllPeopleForASeason200ResponseCrew(self):
        """Test GetAllPeopleForASeason200ResponseCrew"""
