...
class TestShowsApi(unittest.TestCase):
    ...
    def test_get_the_most_favorited_shows(self) -> None:
        """Test case for get_the_most_favorited_shows
    ...
    def test_refresh_show_metadata(self) -> None:
        """Test case for refresh_show_metadata
