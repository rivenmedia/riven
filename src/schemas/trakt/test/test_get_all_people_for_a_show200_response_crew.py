...
class TestGetAllPeopleForAShow200ResponseCrew(unittest.TestCase):
    """GetAllPeopleForAShow200ResponseCrew unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllPeopleForAShow200ResponseCrew:
        """Test GetAllPeopleForAShow200ResponseCrew
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetAllPeopleForAShow200ResponseCrew`
        """
        model = GetAllPeopleForAShow200ResponseCrew()
        if include_optional:
            return GetAllPeopleForAShow200ResponseCrew(
                art = [
    ...
    def testGetAllPeopleForAShow200ResponseCrew(self):
        """Test GetAllPeopleForAShow200ResponseCrew"""
