...
class TestGetTrendingComments200ResponseInner(unittest.TestCase):
    """GetTrendingComments200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTrendingComments200ResponseInner:
        """Test GetTrendingComments200ResponseInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetTrendingComments200ResponseInner`
        """
        model = GetTrendingComments200ResponseInner()
        if include_optional:
            return GetTrendingComments200ResponseInner(
                type = '',
                movie = schemas.trakt.models.get_movies_200_response_inner_movie.Get_movies_200_response_inner_movie(
                    title = '',
                    year = 1.337,
                    ids = schemas.trakt.models.get_movies_200_response_inner_movie_ids.Get_movies_200_response_inner_movie_ids(
                        trakt = 1.337,
                        slug = '',
                        imdb = '',
                        tmdb = 1.337, ), ),
                comment = schemas.trakt.models.get_trending_comments_200_response_inner_comment.Get_trending_comments_200_response_inner_comment(
                    id = 1.337,
                    comment = '',
                    spoiler = True,
                    review = True,
                    ...
                    replies = 1.337,
                    likes = 1.337,
                    user_stats = schemas.trakt.models.get_trending_comments_200_response_inner_comment_user_stats.Get_trending_comments_200_response_inner_comment_user_stats(
                        rating = 1.337,
                        play_count = 1.337,
                        completed_count = 1.337, ),
                    user = schemas.trakt.models.post_a_comment_201_response_user.Post_a_comment_201_response_user(
                        username = '',
                        private = True,
                        name = '',
                        vip = True,
                        vip_ep = True,
                        ids = schemas.trakt.models.post_a_comment_201_response_user_ids.Post_a_comment_201_response_user_ids(
                            slug = '', ), ), ),
                show = schemas.trakt.models.get_shows_200_response_inner_show.Get_shows_200_response_inner_show(
                    title = '',
                    year = 1.337,
                    ids = schemas.trakt.models.get_shows_200_response_inner_show_ids.Get_shows_200_response_inner_show_ids(
                        trakt = 1.337,
                        slug = '',
                        tvdb = 1.337,
                        imdb = '',
                        tmdb = 1.337, ), ),
                season = schemas.trakt.models.get_trending_comments_200_response_inner_season.Get_trending_comments_200_response_inner_season(
                    number = 1.337,
                    ids = schemas.trakt.models.get_trending_comments_200_response_inner_season_ids.Get_trending_comments_200_response_inner_season_ids(
                        trakt = 1.337,
                        tvdb = 1.337,
                        tmdb = 1.337, ), ),
                episode = schemas.trakt.models.get_shows_200_response_inner_episode.Get_shows_200_response_inner_episode(
                    season = 1.337,
                    number = 1.337,
                    title = '',
                    ids = schemas.trakt.models.get_shows_200_response_inner_episode_ids.Get_shows_200_response_inner_episode_ids(
                        trakt = 1.337,
                        tvdb = 1.337,
                        imdb = '',
                        tmdb = 1.337, ), ),
                list = schemas.trakt.models.get_trending_comments_200_response_inner_list.Get_trending_comments_200_response_inner_list(
                    name = '',
                    description = '',
                    privacy = '',
                    share_link = '',
                    ...
                    comment_count = 1.337,
                    likes = 1.337,
                    ids = schemas.trakt.models.get_trending_comments_200_response_inner_list_ids.Get_trending_comments_200_response_inner_list_ids(
                        trakt = 1.337,
                        slug = '', ), )
            )
        else:
    ...
    def testGetTrendingComments200ResponseInner(self):
        """Test GetTrendingComments200ResponseInner"""
