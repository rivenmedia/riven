...
class TestMoviesApi(unittest.TestCase):
    ...
    def test_get_all_videos(self) -> None:
    ...
    def test_get_the_most_favorited_movies(self) -> None:
        """Test case for get_the_most_favorited_movies
    ...
    def test_refresh_movie_metadata(self) -> None:
        """Test case for refresh_movie_metadata
