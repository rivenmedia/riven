...
class TestCalendarsApi(unittest.TestCase):
    ...
    def test_get_dvd_releases_0(self) -> None:
        """Test case for get_dvd_releases_0

        Get DVD releases
        """
        pass

    def test_get_finales(self) -> None:
        """Test case for get_finales

        Get finales
        """
        pass

    def test_get_finales_0(self) -> None:
        """Test case for get_finales_0
    ...
    def test_get_movies_0(self) -> None:
        """Test case for get_movies_0
    ...
    def test_get_new_shows_0(self) -> None:
        """Test case for get_new_shows_0
    ...
    def test_get_season_premieres_0(self) -> None:
        """Test case for get_season_premieres_0
    ...
    def test_get_shows_0(self) -> None:
        """Test case for get_shows_0

        Get shows
        """
        pass

    def test_get_streaming_releases(self) -> None:
        """Test case for get_streaming_releases

        Get streaming releases
        """
        pass

    def test_get_streaming_releases_0(self) -> None:
        """Test case for get_streaming_releases_0
