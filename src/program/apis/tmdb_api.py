...
class TMDBApi:
    ...
    def get_tv_season_details(
        self, series_id: int, season_number: int, params: str = ""
    ):
        """Get TV season details"""
        return self.session.get(f"tv/{series_id}/season/{season_number}?{params}")

    def get_tv_episode_details(
        self, series_id: int, season_number: int, episode_number: int, params: str = ""
    ):
        """Get TV episode details"""
        return self.session.get(
            f"tv/{series_id}/season/{season_number}/episode/{episode_number}?{params}"
        )
