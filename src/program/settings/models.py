...
class FilesystemModel(Observable):
    ...
    episode_file_template: str = Field(
        ...
        description=(
            ...
            "Available variables: title, season, episode, episodes (list for multi-episode files), "
            ...
            "For multi-episode files, use {episodes[0]} and {episodes[-1]} for first and last episode numbers."
        ),
    )
