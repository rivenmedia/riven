...
class BitrateLimitExceededException(Exception):
    """Exception raised when a file exceeds the configured bitrate limit."""
    ...
    def create(
        ...
        if limit_bitrate:
            if duration and duration > 0:
                bitrate_mbps = (filesize_bytes * 8) / (duration * 1_000_000)
