...
class BaseDbItem(DeclarativeBase):
    pass


class MediaItem(BaseDbItem):
    """MediaItem class"""
...
class Season(MediaItem):
    ...
    episodes: Mapped[List["Episode"]] = relationship(lazy=False, back_populates="parent", single_parent=True,
                                                     cascade="all, delete-orphan", foreign_keys="Episode.parent_id")
...
class Show(MediaItem):
    ...
    __tablename__ = "Show"
    _id: Mapped[int] = mapped_column(sqlalchemy.ForeignKey("MediaItem._id"), primary_key=True)
    seasons: Mapped[List["Season"]] = relationship(lazy=False, back_populates="parent", single_parent=True,
                                                   cascade="all, delete-orphan", foreign_keys="Season.parent_id")
