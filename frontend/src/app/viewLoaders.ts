...
export const VIEW_LOADERS: Record<RouteName, ViewLoaderModule> = {
  ...
  "dashboard-services": dashboardView as ViewLoaderModule,
  "dashboard-states": dashboardView as ViewLoaderModule,
  "dashboard-releases": dashboardView as ViewLoaderModule,
